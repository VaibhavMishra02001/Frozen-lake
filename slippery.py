    ...
    while alpha>tol and i<100:
        ...
        for s in range (nS):
            ...
            for j in range (0,len(B)):
              ...
              value_function[s]+= (r) + (p*gamma*prev_value_function[n_s])

            
        alpha = max(alpha,max(np.abs(value_function-prev_value_function)))
    ...
    for s in range (nS):
        ...
        for a in range (nA):
            ...
            for j in range (0,len(B)):
               ...
               p =B[j][0]
               n_s =B[j][1]
               q[a] += (r) + (p*(gamma*value_from_policy[n_s]))
        ...
        for s in range (nS):
            ...
            for a in range (nA):
                ...
                for j in range (0,len(B)):
                   ...
                   p =B[j][0]
                   n_s =B[j][1]
                   q[s][a] +=( r+(p*gamma*value_function[n_s]))
            new_value_function[s]= max(q[s])
        alpha = max(alpha, max(np.abs(new_value_function-value_function)))
        i+=1
    ...
    for s in range (nS):
        ...
        for a in range (nA):
            ...
            for k in range (0,len(B)):
               ...
               p =B[k][0]
               n_s =B[k][1]
               q1[a] +=( r+(p*gamma*value_function[n_s]))
